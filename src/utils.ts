...
// Firebase configuration is expected to be provided via environment variables
// loaded by Webpack's DotenvPlugin.
...
// Initialize Firebase and export the auth singleton
