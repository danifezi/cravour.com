...
if (!ai) {
    console.warn("API key is missing or invalid. AI features will be disabled. This is expected if the API_KEY environment variable is not set.");
}

/**
 * Checks if the AI client is initialized. Throws an error if not.
 */
 ...
 * @returns {Promise<object>} A promise that resolves to the structured shopping plan.
 */
