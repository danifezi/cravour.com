    ...
    document.querySelectorAll<HTMLElement>('[data-icon]').forEach(el => {
        ...
        if (kebabKey) {
            ...
            if (icons[camelCaseKey]) {
                ...
                // Make it idempotent by removing attribute after render
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Since we are using a public demo key, Paystack is always considered configured.
    isPaystackConfigured = true;
    
    const configErrorBanner = document.getElementById('config-error-banner');
    if (configErrorBanner && (!isAiConfigured)) { // Only check for AI config now
