...
function renderAppView() {
    if (currentUser) {
        ...
        // Move hamburger into dashboard for mobile sidebar control
        if (hamburger.parentElement !== appDashboard) {
            appDashboard.prepend(hamburger);
        }
        ...
        // Move hamburger back to header
        if (hamburger.parentElement !== headerContainer) {
...
function addEventListeners() {
    ...
    if (ctaSignUpBtn) ctaSignUpBtn.addEventListener('click', () => openAuthModal(true));
    if (footerSignUpBtn) footerSignUpBtn.addEventListener('click', () => openAuthModal(true));
