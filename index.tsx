...
class CravourApp {
    ...
    private scrollToBottom(selector: string) {
        ...
        if (element) {
            // Use 'auto' behavior for instant scrolling, which is better for rapid updates in a chat.
    ...
    private setupPersonalAccount() {
        ...
        if (this.state.ai) {
            coPilotChat = this.state.ai.chats.create({
                ...
                config: {
                    systemInstruction: `You are Cravour, an expert Nigerian Budget Assistant. Your personality is friendly, savvy, and encouraging. You are here to help the user manage their budget, find deals, and make smart financial decisions.
- All monetary values are in Nigerian Naira (NGN), use the symbol ₦.
- Always be conversational and helpful.
- When asked about affordability, check the user's budgets and recent expenses to give an informed opinion.
- When asked for deals, use the provided local deals data. If no specific deal matches, use your general knowledge of the Nigerian market to suggest alternatives.
- Keep your answers concise and easy to understand.`
    ...
    private renderPersonalSidebar(): string {
        const navItems = [
            { view: 'co-pilot', label: 'AI Co-pilot', icon: icons.coPilot },
            { view: 'insights', label: 'Snapshot', icon: icons.insight },
            ...
            <div class="copilot-view">
                <div class="chat-container">
                    ...
                    <form class="chat-form" id="copilot-chat-form">
                        <input type="text" class="input-field" placeholder="Ask your AI Co-pilot..." required ${this.state.isCoPilotLoading ? 'disabled' : ''}>
    ...
    private renderSidebarBase(navItems: any[], activeView: string): string {
        return `
            <div class="sidebar-header"><a href="#" class="sidebar-logo" data-action="navigate" data-view="co-pilot"><span class="logo-svg">${icons.logo}</span>Cravour</a></div>
